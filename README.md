...
于是 [who-is-actor](https://github.com/reky/who-is-actor) 诞生了 —— 一个**零依赖、零脚本**的 Git 仓库开发者画像分析 Skill。它只用原生 `git` 命令采集数据，然后交给 AI 来解读，生成一份毫不留情的六维度体检报告。
